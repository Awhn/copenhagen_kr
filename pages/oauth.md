...
예를 들어, 액세스 토큰을 사용하면 사용자의 GitHub 프로필을 가져오고 GitHub 사용자 ID를 저장할 수 있습니다. 이를 통해 사용자가 다시 로그인할 때 등록된 계정을 찾을 수 있습니다. OAuth 제공자가 제공하는 이메일 주소가 인증되지 않았을 수 있다는 점을 유의하세요. 이메일을 수동으로 인증하거나 인증되지 않은 사용자의 경우 로그인 절차를 차단해야 할 수 있습니다.
